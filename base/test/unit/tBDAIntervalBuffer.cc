...
using dp3::base::BDAIntervalBuffer;
...
void AddRow(BDABuffer& buffer, double time, double interval,
            dp3::common::rownr_t row_nr, std::size_t baseline_nr, bool flag,
            float weight) {
 ...
 */
void AddShortRow(BDABuffer& buffer, double time, dp3::common::rownr_t row_nr,
 ...
 * @param weight_factor The contribution factor for the row.
 */
void AddLongRow(BDABuffer& buffer, double time, dp3::common::rownr_t row_nr,
