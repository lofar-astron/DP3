...
unsigned int DP3::boolToBit (void* to, const void* from, unsigned int nvalues, unsigned int startbit)
{
  if (nvalues == 0) {
    return 0;
  }
...
unsigned int DP3::bitToBool (void* to, const void* from, unsigned int nvalues, unsigned int startbit)
{
  bool* data = (bool*)to;
