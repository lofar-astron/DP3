...
class DPBuffer {
 public:
  ...
  const casacore::Cube<casacore::Complex>& getData() const { return itsData; }
  casacore::Cube<casacore::Complex>& getData() { return itsData; }
  ...
  const casacore::Vector<rownr_t>& getRowNrs() const { return itsRowNrs; }
