...
namespace DP3 {
void getAxisIndices(const vector<double>& ax_src, const vector<double>& ax_tgt,
                    vector<size_t>& indices, bool nearest) {
...
void gridNearestNeighbor(const vector<double>& x_src,
                         ...
                         const vector<double>& y_tgt, const double* vals_src,
                         double* vals_tgt, bool nearest) {
