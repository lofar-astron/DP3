...
cmd="$dpppexe msin=tNDPPP-generic.MS steps=[split] split.steps=[applybeam,out] split.replaceparms=[out.name,applybeam.usechannelfreq] out.name=[splitout1.ms,splitout2.ms] applybeam.usechannelfreq=[false,true] applybeam.invert=true"
echo $cmd
$cmd
