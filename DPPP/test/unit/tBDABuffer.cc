...
BOOST_AUTO_TEST_CASE( flags )
{
    ...
    BOOST_CHECK_EQUAL(buffer.AddRow(0., 1., 0, 0, n_channels, n_correlations, nullptr, flags2), false);
    BOOST_CHECK(buffer.GetFlags() != nullptr);
    BOOST_CHECK_EQUAL(buffer.GetNumberOfElements(), size_t {n_channels * n_correlations});
...
BOOST_AUTO_TEST_CASE( weights )
{
    ...
    BOOST_CHECK_EQUAL(buffer.AddRow(0., 1., 0, 0, n_channels, n_correlations, nullptr, nullptr, weights3), false);
...
BOOST_AUTO_TEST_CASE( full_res_flags )
{
    ...
    BOOST_CHECK_EQUAL(buffer.AddRow(0., 1., 0, 0, n_channels, n_correlations, nullptr, nullptr, nullptr, flags2), false);
    BOOST_CHECK(buffer.GetFullResFlags() != nullptr);
    BOOST_CHECK_EQUAL(buffer.GetNumberOfElements(), size_t {n_channels * n_correlations});
...
BOOST_AUTO_TEST_CASE( uvw )
{
    ...
    BOOST_CHECK_EQUAL(buffer.AddRow(0., 1., 0, 0, n_channels, n_correlations, nullptr, nullptr, nullptr, nullptr, uvw3), false);
    BOOST_CHECK_EQUAL(buffer.GetNumberOfElements(), size_t {2 * n_channels * n_correlations});
