...
class BdaSolverBuffer {
 public:
   ...
   * @param channel_block_start_frequencies Start frequencies for each channel
   * block. This vector has (n_channel_blocks + 1) items: The start frequency of
   * a block is the end frequency of the previous block.
   ...
   * @param channel_frequencies For each baseline, the center frequencies of all
   * BDA rows.
   */
  void ApplySolutions(
 ...
 private:
   ...
   * 3. ApplySolutions() applies the solutions to the model data.
