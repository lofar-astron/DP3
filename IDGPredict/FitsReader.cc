      ...
      if (tmp == "FREQ" || tmp == "VRAD") {
        ...
        switch (int(val)) {
          ...
          case 1:
            ...
            break;
          case 2:
            _meta.polarization = Polarization::StokesQ;
            break;
          case 3:
            _meta.polarization = Polarization::StokesU;
            break;
          case 4:
            _meta.polarization = Polarization::StokesV;
            break;
          case -1:
            _meta.polarization = Polarization::RR;
            break;
          case -2:
            _meta.polarization = Polarization::LL;
            break;
          case -3:
            _meta.polarization = Polarization::RL;
            break;
          case -4:
            _meta.polarization = Polarization::LR;
            break;
          case -5:
            _meta.polarization = Polarization::XX;
            break;
          case -6:
            _meta.polarization = Polarization::YY;
            break;
          case -7:
            _meta.polarization = Polarization::XY;
            break;
          case -8:
            _meta.polarization = Polarization::YX;
            break;
        }
