...
#include <DPPP_SageCal/Register.h>
#include <DPPP_SageCal/SageCal.h>
#include <DPPP/DPRun.h>

// Define the function to make the SageCal 'constructor' known.
// Its suffix must be the (lowercase) name of the package (library).
void register_sagecal()
{
  LOFAR::DPPP::DPRun::registerStepCtor ("sagecal",
                                        LOFAR::DPPP::SageCal::makeStep);
}
