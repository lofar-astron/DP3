...
def test_reuse_modeldata_from_buffer():
    ...
    # Run only gaincal to have reference solutions
    check_call(
        [
            tcf.DP3EXE,
            "checkparset=1",
    ...
    # Verify that the solutions generated by the two commands are equal
    with h5py.File("solutions_1.h5", "r") as solutions_1, h5py.File(
        "solutions_2.h5", "r"
    ) as solutions_2:
