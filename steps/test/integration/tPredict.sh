...
cmd="$dp3exe msin=tNDPPP-generic.MS msout=. msout.datacolumn=MODEL_DATA steps=[predict] predict.sourcedb=tNDPPP-generic.MS/sky predict.usebeammodel=true predict.operation=subtract"
echo $cmd
$cmd
...
cmd="$dp3exe msin=tNDPPP-generic.MS msout=. msout.datacolumn=MODEL_DATA steps=[predict] predict.sourcedb=tNDPPP-generic.MS/sky predict.usebeammodel=false predict.operation=add"
echo $cmd
$cmd
...
cmd="$dp3exe msin=tNDPPP-generic.MS msout=. steps=[predict] predict.sourcedb=tNDPPP-generic.MS/sky"
echo $cmd
$cmd
...
cmd="$dp3exe msin=tNDPPP-generic.MS msout=. steps=[predict] predict.sourcedb=tNDPPP-generic.MS/sky predict.usebeammodel=true"
echo $cmd
$cmd
# Compare the DATA column of the output MS with the BBS reference output.
