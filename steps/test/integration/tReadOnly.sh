...
cmd="$dp3exe msin=tNDPPP-generic.MS steps=[gaincal] gaincal.parmdb=tNDPPP-generic.MS/inst-diagonal gaincal.sourcedb=tNDPPP-generic.MS/sky gaincal.caltype=diagonal gaincal.parmdb=gaincal.h5 msout="
echo $cmd
$cmd || exit 1
