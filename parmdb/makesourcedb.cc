...
void make(const std::string& in, const std::string& out,
          const std::string& outType, const std::string& format,
          const std::string& prefix, const std::string& suffix, bool append,
          bool average, bool check, const SearchInfo& searchInfo) {
...
std::string readFormat(std::string file, const std::string& catFile) {
